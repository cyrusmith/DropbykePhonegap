define([
    ...
    angular.module('dropbike')
        ...
        .constant("FACEBOOK_REDIRECT_URL", "http://ec2-54-69-186-125.us-west-2.compute.amazonaws.com:8080")

        .constant("WEBSITE", "http://dropbyke.com")
        .constant("BANNER_IMAGE", "http://ec2-54-69-186-125.us-west-2.compute.amazonaws.com:8080/DropbikeBackend-0.1/images/banner.jpg")

        .constant('BACKEND_URL', 'http://192.168.1.104:8081/DropbikeBackend')
        //.constant('BACKEND_URL', 'http://192.168.1.104:8080/DropbikeBackend-0.1')
